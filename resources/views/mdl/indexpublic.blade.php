          ...
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            ...
            <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
              ...
              <div class="mdl-card__actions">
                <button id="show-infopublic<?php echo $j;?>" class="mdl-button mdl-js-button mdl-button--accent">View Message</button>
              </div>
            </div>
          </section>
          <script>
            
            $('#show-infopublic<?php echo $j;?>').click(function () {
                    showDialog({
                      title: 'Physical Notice<?php echo $j?>',
                      text: '<div><iframe src="{{  url("/uploads/test/up/notice/".$rws->notice_content) }}"style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); width: 100%; min-height: 450px;"></iframe></div>',
                       negative: {
                                title: 'Cancel'
                            },
                  })
