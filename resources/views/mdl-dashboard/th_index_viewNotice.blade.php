          ...
          <table class="table table-striped table-advance table-hover">
            <tbody>
             <tr>
              ...
              @if($noticesTeacher->count())
              @foreach($noticesTeacher as $rows)
              <tr>
                ...
                <td>
                  ...
                  @if($rows->notice_status == '1')
                    ...
                    @else
                    <a class="btn btn-danger" href="{{ route('getApproveRouteTh',$rows->notice_id) }}" title="Waiting for approval"><strong>Approve</strong></a>
                    @endif
                    @if($rows->notice_content !='')
                    <a class="btn btn-primary" href="#myModalDDth{{ $rows->notice_id}}"data-toggle="modal" title="View attachment"><i class="icon_plus_alt2"></i></a>
                    @else
                    <button type="button" class="btn btn-primary disabled"><strong>No file</strong></button>
                    @endif
                    <!-- Modal -->
                      <div class="modal fade" id="myModalDDth{{ $rows->notice_id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <a class="btn btn-danger"href="#myModalDcth{{ $rows->notice_id }}" 
                    onclick='return confirmDelete();'data-toggle="modal" title="Delete">
                     <i class="icon_close_alt2"></i></a>
                     <!-- Modal -->
                      <div class="modal fade" id="myModalDcth{{ $rows->notice_id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog" style="width: 444px;">
                         <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <a class="btn btn-default" href="{{route('deleteNoticeRouteTh',$rows->notice_id) }}">Delete</a>
                          </div>
                         </div>
                      </div>
                    </div>
