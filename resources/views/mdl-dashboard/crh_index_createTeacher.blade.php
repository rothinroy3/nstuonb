...
@if(Session::has('CreateTeachersuccess'))
  <div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="alert alert-block alert-success fade in">
            ...
            <strong>Successfull!!&nbsp; </strong>{!! Session::get('CreateTeachersuccess') !!}
        </div>
  </div>
  </div>
@endif
@if(Session::has('MessageDeleteTeacher'))
  <div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="alert alert-block alert-success fade in">
            <button data-dismiss="alert" class="close close-sm" type="button">
            ...
            <strong>Successfull!!&nbsp; </strong>{!! Session::get('MessageDeleteTeacher') !!}
        </div>
  </div>
  </div>
@endif
          ...
          <table class="table table-striped table-advance table-hover">
            <tbody>
             <tr>
               ...
               <th style="width: "><i class="icon_profile"></i> Name/Username </th>
               <th style="width: "><i class="icon_cogs"></i> Action </th>
              </tr>
              <?php $i = 1; ?>
              @foreach($all_th as $rows)
              <tr>
                <td>&nbsp;&nbsp;{{ $i++ }}</td>
                <td>{{ $rows->th_name }}</td>
                <td>
                        ...
                        <div class="modal-dialog" style="width: 444px;">
                         <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a class="btn btn-default" href="{{route('deleteTeacherRoute',$rows->id) }}">Delete</a>
                          </div>
                         </div>
                      </div>
                    </div>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <header style="margin-top: 0px;padding: 12px 10px 10px;color: rgb(54, 56, 54);font-size: 16px">Create a Teacher Account</header>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/loggedin/createTeacher') }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}

                        <div class="form-group{{ $errors->has('th_name') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label"style="font-size: 14px;font-style: oblique;font-weight: bold;">Teacher Name</label>

                            <div class="col-md-6">
                                <input type="text" name="th_name"value="{{ old('th_name') }}"  class="form-control" placeholder="New Teacher Name *">
                        ...
                        <div class="form-group{{ $errors->has('th_username') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label"style="font-size: 14px;font-style: oblique;font-weight: bold;">Teacher Username</label>

                            <div class="col-md-6">
                                <input type="text" name="th_username"value="{{ old('th_username') }}"  class="form-control" placeholder="New Teacher Username *">
                        ...
                        <div class="form-group{{ $errors->has('th_password') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label"style="font-size: 14px;font-style: oblique;font-weight: bold;">Teacher Password</label>

                            <div class="col-md-6">
                                <input type="password" name="th_password" value="{{ old('th_password') }}"  class="form-control" placeholder="New Teacher Password *">
